...
export class PermissaoController {
    constructor(
      private fraseService: PermissaoService,
    ...
    @Post()
    create(@Body() dto: Permissao, @Req() req: Request, @Res() res: Response) {
    ...
    @Put(':id')
    update(@Param('id') id: string, @Body() dto: Permissao, @Req() req: Request, @Res() res: Response) {
